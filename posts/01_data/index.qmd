...
duke_uconn |>
  ...
  labs(
    y = "Duke's Lead Differential",
    x = "Time Elapsed (seconds)",
    title = "Duke vs UConn Game"
  ) +
  theme_minimal()
```
...
- `rating_diff`: the difference between the home and away team ratings (home - away)
