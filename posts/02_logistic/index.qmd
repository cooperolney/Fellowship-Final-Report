...
The adjustment also shifted the remaining regression curves downward. This occurs because the model is no longer attributing part of the home team's expected success to a built-in home-court advantage. As a result, the predictions better reflect games played on neutral courts, such as NCAA Tournament games, where neither team should receive an advantage simply from being designated as the home team.

Although the starting probabilities changed noticeably, the overall shape of the curves remained similar. As the game progresses, score differential and time elapsed become increasingly important, causing the effect of the pregame adjustment to diminish.
